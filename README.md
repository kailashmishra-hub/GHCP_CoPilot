...
--------------------------
The dashboard analyzes an active GitHub or Azure DevOps pull request, traces
Java/page-object and step-definition changes to Cucumber scenarios and tags, and
selects a small regression subset using coverage optimization. Private Azure
